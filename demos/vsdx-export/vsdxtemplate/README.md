...
- Click on the "Export to VSDX" button to export the current graph using the template.
- The exported file will use the styles and masters defined in the template VSDX file.
